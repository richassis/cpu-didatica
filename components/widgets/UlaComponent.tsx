...
export default function UlaComponent({ component, zoom }: Props) {
  ...
  const resultHex = ula ? ula.resultHex() : "0000";
    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* Result — visible only on hover */}
          <span
            className={`text-xs font-mono text-indigo-200 bg-indigo-950/70 rounded px-1.5 py-0.5 leading-none transition-opacity duration-150 ${
